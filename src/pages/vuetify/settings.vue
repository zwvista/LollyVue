<template>
  ...
  <b-container v-if="settingsService.selectedLang">
    <b-form-group class="mb-2" label="Language:" label-for="lang" label-cols="2" content-cols="4">
    ...
    <b-form-group class="mb-2" label="Voice:" label-for="voice" label-cols="2" content-cols="4">
    ...
    <b-form-group class="mb-2" label="Dictionary(Reference):" label-for="dictReference" label-cols="2" content-cols="4">
    ...
    <b-form-group class="mb-2" label="Dictionary(Note):" label-for="dictNote" label-cols="2" content-cols="4">
    ...
    <b-form-group class="mb-2" label="Dictionary(Translation):" label-for="dictTranslation" label-cols="2" content-cols="4">
    ...
    <b-form-group class="mb-2" label="Textbook:" label-for="textbook" label-cols="2" content-cols="4">
    ...
    <b-form-group class="mb-2" label="Unit:" label-cols="2" content-cols="4">
      <b-input-group>
    ...
    <b-form-group class="mb-2" label-cols="2" content-cols="4">
      <b-button-group>
