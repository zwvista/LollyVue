<template>
  <div>
    <el-row>
      <el-col :span="4">
        <el-input placeholder="Filter" v-model="wordsLangService.filter" @input="onRefresh" class="input-with-select">
          <el-select v-model="wordsLangService.filterType" slot="prepend" @change="onRefresh">
            <el-option
